...
describe('P0.E.FT5.2B AW_M_01 layered replication', () => {
  it('FT52B-1 — production background registered (not hardcoded URL)', () => {
    expect(AW_M_01_WORLD_ENTRY_BACKGROUND_V2.slotKey).toBe('AW_M_01_WORLD_ENTRY_BACKGROUND_V2');
    expect(resolveAwM01BackgroundPath()).toContain('AW_M_01_WORLD_ENTRY_BACKGROUND_V2.png');
