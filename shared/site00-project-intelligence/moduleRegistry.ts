...
export const PROJECT_INTELLIGENCE_MODULE_REGISTRY: ProjectIntelligenceModuleDefinition[] = [
  ...
  {
    moduleId: 'BRAND_CHARACTER_DEEPENING',
    label: 'Brand Character Deepening',
    requiredDependencies: ['BRAND_LORE', 'BRAND_PERSONALITY'],
    recommendedDependencies: ['FOUNDER_CREATIVE_APPETITE'],
    readinessContribution: 0,
    existingSystemRoute: '/projects/:slug/brand-character-deepening',
  },
