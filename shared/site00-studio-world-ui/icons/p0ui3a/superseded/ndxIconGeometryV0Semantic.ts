/**
 * P0.UI.3 — superseded semantic-approximation geometry (preserved for lineage).
 * Classification: GENERIC_SEMANTIC_APPROXIMATION
 */
import type { NDXIconName, NdxIconDefinition } from '../../types.js';

export const NDX_ICON_GEOMETRY_V0_SEMANTIC: Record<NDXIconName, NdxIconDefinition> = {
  overview: {
    name: 'overview',
    paths: [
      { d: 'M4 4h7v7H4z' },
...
export const NDX_ICON_GEOMETRY_V0_SUPERSESSION = 'SUPERSEDED_BY_REFERENCE_TRACE' as const;
