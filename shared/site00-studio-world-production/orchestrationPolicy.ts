...
export const SITE_PRODUCTION_ORCHESTRATION_POLICIES: ProductionOrchestrationPolicy[] = [
  ...
  {
    stage: 'BRAND_CHARACTER_TERRITORY_REVIEW',
    discipline: 'IDENTITY',
    actor: 'FOUNDER',
    triggerMode: 'MANUAL_INTERNAL',
    costClass: 'FREE',
    parallelizationPolicy: 'SEQUENTIAL',
    requiredGates: ['BRAND_CHARACTER_TERRITORIES_FORMED'],
    produces: ['BRAND_CHARACTER_TERRITORY_JUDGMENT'],
    invalidates: [],
    liveVerificationRequired: false,
    founderApprovalRequired: true,
    methodologyVersion: P0_5A_METHODOLOGY_VERSION,
  ...
  {
    stage: 'BRAND_CHARACTER_DEVELOPMENT',
    discipline: 'IDENTITY',
    actor: 'ANTHROPIC',
    triggerMode: 'FOUNDER_TRIGGERED',
    costClass: 'MEDIUM',
    parallelizationPolicy: 'SEQUENTIAL',
    requiredGates: ['BRAND_CHARACTER_TERRITORY_PROMISING'],
    produces: ['BRAND_CHARACTER_DEVELOPMENT'],
    invalidates: ['BRAND_CHARACTER_SYSTEM'],
    liveVerificationRequired: false,
    founderApprovalRequired: true,
    methodologyVersion: P0_5A_METHODOLOGY_VERSION,
  ...
  {
    stage: 'BRAND_CHARACTER_DEVELOPED_SEMANTIC_AUDIT',
    discipline: 'IDENTITY',
    actor: 'ANTHROPIC',
    triggerMode: 'SYSTEM_CONDITION',
    costClass: 'LOW',
    parallelizationPolicy: 'SEQUENTIAL',
    requiredGates: ['BRAND_CHARACTER_DEVELOPMENT_COMPLETE'],
    produces: ['BRAND_CHARACTER_DEVELOPMENT_AUDIT'],
    invalidates: [],
    liveVerificationRequired: false,
    founderApprovalRequired: false,
    methodologyVersion: P0_5A_METHODOLOGY_VERSION,
  ...
  {
    stage: 'BRAND_CHARACTER_FINAL_SELECTION',
    discipline: 'IDENTITY',
    actor: 'FOUNDER',
    triggerMode: 'MANUAL_INTERNAL',
    costClass: 'FREE',
    parallelizationPolicy: 'SEQUENTIAL',
    requiredGates: ['BRAND_CHARACTER_DEVELOPMENT_REVIEWED'],
    produces: ['BRAND_CHARACTER_SELECTION'],
    invalidates: [],
    liveVerificationRequired: false,
    founderApprovalRequired: true,
    methodologyVersion: P0_5A_METHODOLOGY_VERSION,
  },
  {
    ...
    costClass: 'FREE',
    parallelizationPolicy: 'SEQUENTIAL',
    requiredGates: ['BRAND_CHARACTER_DEVELOPMENT_APPROVED'],
