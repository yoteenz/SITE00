...
export type ConceptDirectedTwinRendered = {
  renderMode: 'TWIN_V2_CONCEPT_DIRECTED_NDX_OVERVIEW' | 'TWIN_V2_PACKAGE_DRIVEN_NDX_OVERVIEW';
  componentRef: 'ConceptDirectedNdxOverviewTwinV2' | 'ConceptDirectedPackageTwinV2';
  builtAt: string | null;
