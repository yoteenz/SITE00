...
function regionSpecFromBundle(
  ...
  return {
    ...
    measurementDepth: bundle.measurementDepth,
    requiredDimensions: bundle.measurementDepth?.requiredDimensions,
    resolvedDimensions: bundle.measurementDepth?.resolvedDimensions,
    missingDimensions: bundle.measurementDepth?.missingDimensions,
