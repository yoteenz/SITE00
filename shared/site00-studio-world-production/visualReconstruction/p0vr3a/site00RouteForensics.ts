...
export function buildSite00DiscoveredRoutes(): StudioWorldDesignRouteManifestEntry[] {
  const routes: StudioWorldDesignRouteManifestEntry[] = [
    ...
    screen({
      screenId: 'guide',
      displayName: 'Guide',
      routePattern: SITE00_ROUTES.guide,
      absoluteRoute: true,
      scopeTargetId: 'guidePage',
      routeFamily: 'INFORMATION',
      classification: 'CUSTOMER_FACING',
      recordKind: 'ROUTE',
      priority: 'SECONDARY',
      componentName: 'GuidePage',
      sourceEvidence: ['P0.VR.3H-SITE00', 'src/site00/pages/information/GuidePage.tsx'],
      dependencyClosure: 'IMPLEMENTED_DRAFT',
    }),
    screen({
      screenId: 'sound',
      displayName: 'Sound',
      routePattern: SITE00_ROUTES.sound,
      absoluteRoute: true,
      scopeTargetId: 'soundPage',
      routeFamily: 'INFORMATION',
      classification: 'CUSTOMER_FACING',
      recordKind: 'ROUTE',
      priority: 'SECONDARY',
      componentName: 'SoundPage',
      sourceEvidence: ['P0.VR.3H-SITE00', 'src/site00/pages/information/SoundPage.tsx'],
      dependencyClosure: 'IMPLEMENTED_DRAFT',
    }),
    screen({
      screenId: 'faq',
      displayName: 'FAQ',
      routePattern: SITE00_ROUTES.faq,
      absoluteRoute: true,
      scopeTargetId: 'faqPage',
      routeFamily: 'INFORMATION',
      classification: 'CUSTOMER_FACING',
      recordKind: 'ROUTE',
      priority: 'SECONDARY',
      componentName: 'FaqPage',
      sourceEvidence: ['P0.VR.3H-SITE00', 'src/site00/pages/information/FaqPage.tsx'],
      dependencyClosure: 'IMPLEMENTED_DRAFT',
    }),
    screen({
      screenId: 'contact',
      displayName: 'Contact',
      routePattern: SITE00_ROUTES.contact,
      absoluteRoute: true,
      scopeTargetId: 'contactPage',
      routeFamily: 'INFORMATION',
      classification: 'CUSTOMER_FACING',
      recordKind: 'ROUTE',
      priority: 'SECONDARY',
      componentName: 'ContactPage',
      sourceEvidence: ['P0.VR.3H-SITE00', 'src/site00/pages/information/ContactPage.tsx'],
      dependencyClosure: 'IMPLEMENTED_DRAFT',
    }),
    screen({
      screenId: 'blueprints',
      displayName: 'Blueprints',
      routePattern: SITE00_ROUTES.blueprints,
      absoluteRoute: true,
      scopeTargetId: 'blueprintsPage',
      routeFamily: 'INFORMATION',
      classification: 'CUSTOMER_FACING',
      recordKind: 'ROUTE',
      priority: 'SECONDARY',
      componentName: 'BlueprintsPage',
      sourceEvidence: ['P0.VR.3H-SITE00', 'src/site00/pages/complex/BlueprintsPage.tsx'],
      dependencyClosure: 'IMPLEMENTED_DRAFT',
    }),
    screen({
      screenId: 'forgot-password',
      displayName: 'Forgot Password',
      routePattern: SITE00_ROUTES.forgotPassword,
      absoluteRoute: true,
      scopeTargetId: 'forgotPasswordPage',
      routeFamily: 'ACCOUNT',
      classification: 'CUSTOMER_FACING',
      recordKind: 'ROUTE',
      priority: 'SECONDARY',
      componentName: 'Site00ForgotPasswordPage',
      parentScreenId: 'sign-in',
      sourceEvidence: ['P0.VR.3H-SITE00', 'src/site00/pages/auth/Site00ForgotPasswordPage.tsx'],
      dependencyClosure: 'IMPLEMENTED_DRAFT',
    }),
    screen({
      screenId: 'reset-password',
      displayName: 'Reset Password',
      routePattern: SITE00_ROUTES.resetPassword,
      absoluteRoute: true,
      scopeTargetId: 'resetPasswordPage',
      routeFamily: 'ACCOUNT',
      classification: 'CUSTOMER_FACING',
      recordKind: 'ROUTE',
      priority: 'SECONDARY',
      componentName: 'Site00ResetPasswordPage',
      parentScreenId: 'sign-in',
      sourceEvidence: ['P0.VR.3H-SITE00', 'src/site00/pages/auth/Site00ResetPasswordPage.tsx'],
      dependencyClosure: 'IMPLEMENTED_DRAFT',
    }),
    screen({
      screenId: 'account-profile',
      displayName: 'Account Profile',
      routePattern: SITE00_ROUTES.accountProfile,
      absoluteRoute: true,
      scopeTargetId: 'accountProfilePage',
      routeFamily: 'ACCOUNT',
      classification: 'CUSTOMER_FACING',
      recordKind: 'ROUTE',
      priority: 'SECONDARY',
      componentName: 'AccountPage',
      sourceEvidence: ['P0.VR.3H-SITE00', 'src/site00/pages/complex/AccountPage.tsx'],
      dependencyClosure: 'IMPLEMENTED_DRAFT',
    }),
    screen({
      screenId: 'brand-page',
      displayName: 'Brand',
      routePattern: SITE00_ROUTES.brand,
      absoluteRoute: true,
      scopeTargetId: 'brandPage',
      routeFamily: 'IDENTITY',
      classification: 'CUSTOMER_FACING',
      recordKind: 'ROUTE',
      priority: 'SECONDARY',
      componentName: 'BrandPage',
      sourceEvidence: ['P0.VR.3H-SITE00', 'src/site00/pages/complex/BrandPage.tsx'],
      dependencyClosure: 'IMPLEMENTED_DRAFT',
    }),
    screen({
      screenId: 'services',
...
export function buildSite00MissingRoutes(): Site00MissingRouteRecord[] {
  ...
  const composerDraftRoutes = new Set([
    '/guide',
    '/sound',
    '/faq',
    '/contact',
  ...
  const filteredNav = missingFromNav.filter((m) => !composerDraftRoutes.has(m.suggestedRoute) && !existingRoutes.has(m.suggestedRoute));
  const filteredAuth = authMissing.filter((m) => !composerDraftRoutes.has(m.suggestedRoute) && !existingRoutes.has(m.suggestedRoute));

  return [...filteredNav, ...filteredAuth];
}
...
/** Composer-implemented draft routes for design workspace (P0.VR.3H). */
export function composerDraftRoutesAsDesignScreens(): DesignScreenDefinition[] {
  const drafts = buildSite00DiscoveredRoutes().filter((r) => r.dependencyClosure === 'IMPLEMENTED_DRAFT');
  return drafts.map((r) => ({
    screenId: r.screenId,
    displayName: `${r.displayName} (COMPOSER DRAFT)`,
    routePattern: r.resolvedRoute,
    absoluteRoute: true,
    ...
    recordKind: 'ROUTE',
    priority: r.priority,
    parentScreenId: r.parentScreenId,
