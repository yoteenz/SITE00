...
export const ASTRAL_HOTSPOTS: AstralHotspotDef[] = [
  ...
  // ASTREA_DISTRICT
  {
    ...
    rect: { xPercent: 4, yPercent: 38, widthPercent: 28, heightPercent: 32 },
    mobileAdjustment: { xPercent: 2, yPercent: 34, widthPercent: 32, heightPercent: 36 },
  },
  {
    ...
    rect: { xPercent: 36, yPercent: 28, widthPercent: 28, heightPercent: 38 },
    mobileAdjustment: { xPercent: 34, yPercent: 24, widthPercent: 32, heightPercent: 42 },
  },
  {
    ...
    rect: { xPercent: 68, yPercent: 42, widthPercent: 28, heightPercent: 34 },
    mobileAdjustment: { xPercent: 66, yPercent: 38, widthPercent: 32, heightPercent: 38 },
  },
  // TAROT_SUITE
  {
  ...
  // ASTRAL_MALL
  {
    hotspotId: 'MALL_CENTRAL_KIOSK',
    sceneId: 'ASTRAL_MALL',
    assetAnchor: 'CENTRAL_KIOSK',
    label: 'Central Kiosk',
    action: 'OPEN_DRAWER',
    target: 'kiosk-central',
  ...
  },
  {
    ...
    action: 'OPEN_DRAWER',
    target: 'kiosk-love',
    rect: { xPercent: 8, yPercent: 44, widthPercent: 22, heightPercent: 28 },
  },
  {
    ...
    action: 'OPEN_DRAWER',
    target: 'kiosk-career',
    rect: { xPercent: 72, yPercent: 40, widthPercent: 22, heightPercent: 28 },
  },
  {
    ...
    action: 'OPEN_DRAWER',
    target: 'kiosk-quick',
    rect: { xPercent: 58, yPercent: 52, widthPercent: 20, heightPercent: 24 },
  },
  // COFFEE_SHOP
  {
    hotspotId: 'TABLE_01',
