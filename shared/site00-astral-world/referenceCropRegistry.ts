...
export const ASTRAL_REFERENCE_CROPS: Record<ReferenceCropKey, CropSpec> = {
  ...
  ASTRAL_WORLD_HERO_MOBILE: { src: M, position: '50% 0%', size: '100% auto', aspectRatio: '941/520', focalPoint: 'center 22%' },
  ...
  TAROT_SUITE_MOBILE: { src: M, position: '50% 52%', size: '220% auto', aspectRatio: '4/5', focalPoint: 'right center' },
  ASTRAL_MALL: { src: D, position: '50% 72%', size: '220% auto', aspectRatio: '4/5', focalPoint: 'center' },
  ASTRAL_MALL_MOBILE: { src: M, position: '50% 62%', size: '220% auto', aspectRatio: '4/5', focalPoint: 'right center' },
  COFFEE_SHOP: { src: D, position: '82% 72%', size: '220% auto', aspectRatio: '4/5', focalPoint: 'center' },
  COFFEE_SHOP_MOBILE: { src: M, position: '50% 57%', size: '220% auto', aspectRatio: '4/5', focalPoint: 'right center' },
