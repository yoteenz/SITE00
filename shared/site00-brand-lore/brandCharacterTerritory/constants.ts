...
export const BRAND_CHARACTER_METHODOLOGY_V2 = 'BRAND_CHARACTER_METHODOLOGY_V2' as const;
...
export const PROMISING_DEVELOP_JUDGMENTS = ['LOVE_THE_CHARACTER', 'PROMISING_DEVELOP'] as const;
