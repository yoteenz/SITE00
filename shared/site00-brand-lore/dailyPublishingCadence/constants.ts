...
/** Canonical second-Reel optional policy (P0.5E.1A). */
export const SECOND_REEL_OPTIONAL_POLICY_IMPLEMENTED = true as const;
/**
 * @deprecated Compatibility alias — historical P0.5E.1 identifier. Use SECOND_REEL_OPTIONAL_POLICY_IMPLEMENTED.
 * Preserved for persisted records and backward-compatible assertions.
 */
export const THIRD_REEL_OPTIONAL_POLICY_IMPLEMENTED = SECOND_REEL_OPTIONAL_POLICY_IMPLEMENTED;
export const CADENCE_DOES_NOT_FORCE_FILLER = true as const;
export const NDX_WEEKLY_APPROVAL_FLOW_IMPLEMENTED = true as const;
export const CADENCE_IS_NOT_QUOTA = true as const;
export const OPTIONAL_CAPACITY_IS_NOT_TARGET = true as const;

/** Derived from per-channel targets — not independently hardcoded totals. */
export const NDX_DAILY_BASELINE_PUBLISHING_UNITS =
  NDX_INSTAGRAM_FEED_TARGET_PER_DAY +
  NDX_INSTAGRAM_STORY_TARGET_PER_DAY +
  NDX_INSTAGRAM_REEL_TARGET_PER_DAY;
export const NDX_WEEKLY_BASELINE_PUBLISHING_UNITS = NDX_DAILY_BASELINE_PUBLISHING_UNITS * 7;
export const NDX_DAILY_MAX_NORMAL_PUBLISHING_UNITS =
  NDX_INSTAGRAM_FEED_TARGET_PER_DAY +
  NDX_INSTAGRAM_STORY_TARGET_PER_DAY +
  NDX_INSTAGRAM_REEL_MAX_NORMAL_PER_DAY;
export const NDX_WEEKLY_MAX_NORMAL_PUBLISHING_UNITS = NDX_DAILY_MAX_NORMAL_PUBLISHING_UNITS * 7;
