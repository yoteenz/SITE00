...
export function buildEntry002CinematicVisualSequenceFrames(): CinematicVisualSequenceFrame[] {
  return [
    ...
    frame(2, {
      argumentBeat: 'CLAIM',
      shotPurpose: 'Subject woman post gaining momentum — NDX observes',
      visualDescription:
        '2026 present-day. Subject woman\'s post on phone gaining viral praise for 2016 baddie fashion energy. Real-time comment energy. NDX partial presence at frame edge — over-shoulder or shadow only.',
      cameraBehavior: 'Medium close on phone screen with subject woman post — NDX partial at edge',
      characterPresence: 'Subject woman visible in post; NDX partial silhouette/hands only — NOT full NDX face',
      ...
      continuityNotes: 'NDX and subject woman are DISTINCT — subject woman is post subject; NDX is partial observer',
