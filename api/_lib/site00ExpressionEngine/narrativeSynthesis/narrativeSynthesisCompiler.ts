...
function compileGenericNarrativeBeatSeeds(input: NarrativeSynthesisInput): BeatSeed[] {
  const world = input.worldCandidates[0]?.label ?? 'WORLD';
  const artifact = input.artifactCandidates[0]?.label ?? 'ARTIFACT';
  const interjection = input.interjectionCandidates[0] ?? input.thesis;
  ...
  return [
    {
      ...
      whatHappens: `Public claim surfaces: ${input.thesis}`,
      whyItHappensNow: 'Feed culture normalizes the claim — audience recognizes the language immediately.',
      causedBy: ['Chapter grammar CLAIM', 'Cultural moment'],
      reveals: [input.thesis],
      emotionalBefore: 'CURIOSITY',
      emotionalAfter: 'RECOGNITION',
      world,
      transitionOut: 'Receipt hunt begins',
      causal: { causes: true, reveals: true, earns: true },
    },
    {
      beatId: 'ns-question',
      beatType: 'QUESTION',
      storyFunction: 'Live question',
      whatHappens: `Central question forms around ${input.lockedContradiction ?? input.thesis}`,
      whyItHappensNow: 'Claim feels incomplete once audience recalls contradictory lived experience.',
      causedBy: ['ns-setup'],
      reveals: ['Contradiction may exist'],
      emotionalBefore: 'RECOGNITION',
      emotionalAfter: 'UNEASE',
      ndx: 'NDX notices the gap',
      transitionOut: 'Investigation opens',
      causal: { causes: true, reveals: true, earns: true },
    },
    {
      beatId: 'ns-discovery',
      beatType: 'DISCOVERY',
      storyFunction: 'First receipt',
      whatHappens: `First receipt discovered via ${artifact}`,
      whyItHappensNow: 'Question demands evidence — not opinion.',
      causedBy: ['ns-question'],
      reveals: ['Measurable record contradicts public claim'],
      emotionalBefore: 'UNEASE',
      emotionalAfter: 'ANTICIPATION',
      artifact,
      transitionOut: 'Escalation',
      causal: { causes: true, reveals: true, earns: true },
    },
    {
      beatId: 'ns-escalation',
      beatType: 'ESCALATION',
      storyFunction: 'Receipts accumulate',
      whatHappens: 'Additional receipts stack — pattern becomes undeniable.',
      whyItHappensNow: 'Single receipt could be anomaly; pattern implicates culture not individual.',
      causedBy: ['ns-discovery'],
      reveals: ['Systemic contradiction, not one-off hypocrisy'],
      emotionalBefore: 'ANTICIPATION',
      emotionalAfter: 'TENSION',
      world,
      transitionOut: 'Turn approaches',
      causal: { causes: true, reveals: true, earns: true },
    },
    {
      beatId: 'ns-turn',
      beatType: 'TURN',
      storyFunction: 'Semantic turn',
      whatHappens: 'Same subject, same timeline — public rest language vs private labor metrics collide.',
      whyItHappensNow: 'Accumulated receipts force reinterpretation of opening claim.',
      causedBy: ['ns-escalation'],
      reveals: [input.lockedPremise ?? 'Contradiction proven'],
      emotionalBefore: 'TENSION',
      emotionalAfter: 'DISBELIEF',
      artifact,
      transitionOut: 'Contradiction named',
      causal: { causes: true, reveals: true, earns: true },
    },
    {
      beatId: 'ns-contradiction',
      beatType: 'CONTRADICTION',
      storyFunction: 'Contradiction explicit',
      whatHappens: input.lockedContradiction ?? 'Both positions cannot survive the receipts.',
      whyItHappensNow: 'Turn made contradiction legible — now it must be stated cleanly.',
      causedBy: ['ns-turn'],
      reveals: ['Argument proven'],
      emotionalBefore: 'DISBELIEF',
      emotionalAfter: 'REALIZATION',
    ...
    },
    {
      beatId: 'ns-interjection',
      beatType: 'INTERJECTION',
      storyFunction: 'NDX names truth',
      whatHappens: interjection,
      whyItHappensNow: 'Contradiction is proven — interjection can land without explaining away.',
      causedBy: ['ns-contradiction'],
      reveals: ['Named cultural hypocrisy'],
      emotionalBefore: 'REALIZATION',
      emotionalAfter: 'SATISFACTION',
      ndx: 'NDX interjection',
      transitionOut: 'Payoff',
      causal: { causes: true, reveals: true, earns: true },
    },
    {
      beatId: 'ns-payoff',
      beatType: 'PAYOFF',
      storyFunction: 'Intellectual payoff',
      whatHappens: 'Opening claim reframed — audience understands the mechanism.',
      whyItHappensNow: 'Interjection sharpened thesis — payoff completes argument arc.',
      causedBy: ['ns-interjection'],
      reveals: [input.thesis],
      emotionalBefore: 'SATISFACTION',
      emotionalAfter: 'SATISFACTION',
      payoffLink: 'ns-setup',
      transitionOut: 'Aftershock',
      causal: { causes: true, reveals: true, earns: true },
    },
    {
      beatId: 'ns-aftershock',
      beatType: 'AFTERSHOCK',
      storyFunction: 'Continuation hook',
      whatHappens: 'Culture already preparing the next wellness post before receipts cool.',
      whyItHappensNow: 'Argument implies cycle — audience left with complicity question.',
      causedBy: ['ns-payoff'],
      reveals: ['Chapter-scale question continues'],
      emotionalBefore: 'SATISFACTION',
      emotionalAfter: 'AFTERSHOCK',
      transitionOut: 'Handoff',
      causal: { causes: false, reveals: true, earns: false },
    },
  ];
}
