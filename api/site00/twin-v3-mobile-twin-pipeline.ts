...
import { P0_VR_TWIN_V30_BUILD, P0_VR_TWIN_V30R7MF3P1_LINEAGE } from '../../shared/site00-studio-world-production/visualReconstruction/p0vrTwinV30/constants.js';
import {
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (req.method === 'GET') {
    res.status(200).json({
      ...
      sprint: P0_VR_TWIN_V30R7MF3P1_LINEAGE,
    });
    return;
  }
