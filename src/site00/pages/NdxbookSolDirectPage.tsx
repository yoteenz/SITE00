  ...
  return (
    <section className="sol-panel sol-readiness">
      ...
      <div className="sol-ready-grid">
        ...
        <div className="sol-checks"><small>CHECKS</small>{['LAYOUT SYSTEM','TYPE SCALE','ASSET LINKS','FUNCTION MAP','ACCESSIBILITY'].map((x, i)=><p key={x}>{x}<CheckDot warn={i === 4} /></p>)}<button>VIEW DETAILS</button></div>
