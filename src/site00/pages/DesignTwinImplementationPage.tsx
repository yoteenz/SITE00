...
import { P0_VR_TWIN_V30R8M2_LINEAGE } from '../../../shared/site00-studio-world-production/visualReconstruction/p0vrTwinV30R8M2/constants.js';
...
export function DesignTwinImplementationPage() {
  ...
  if (loading) {
    return (
      <div className="site00-page site00-page--twin-implementation" data-lineage={P0_VR_TWIN_V30R8M2_LINEAGE}>
        {header}
