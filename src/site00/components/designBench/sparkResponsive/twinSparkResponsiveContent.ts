/**
 * P0.VR.DESIGNBENCH.SPARK-RESPONSIVE-OPUSGROK1 — live text content for the isolated Opus direct
...
export const TWIN_SPARK_RESPONSIVE_LINEAGE = 'P0.VR.DESIGNBENCH.SPARK-RESPONSIVE-OPUSGROK1' as const;

/** Golden reference pixel dimensions (founder attachment). */
export const TWIN_SPARK_RESPONSIVE_REFERENCE_VIEWPORT = { width: 768, height: 1376 } as const;

/** Repo copy of the same golden, used for pixel QA. */
export const TWIN_SPARK_RESPONSIVE_GOLDEN_MASTER_PATH =
  '/site00/twin-v3-design-page-authority/founder-r5f2-ndxbook/mobile-master.jpg';

export const TWIN_SPARK_RESPONSIVE_PRIMARY_NAV = [
  'REFERENCES',
  'ASSETS',
  'PAGES',
  'SKINS',
...
export const TWIN_SPARK_RESPONSIVE_VIEWPORTS: readonly TwinSparkResponsiveViewportId[] = [
  'MOBILE',
  'TABLET',
  'DESKTOP',
];

export const TWIN_SPARK_RESPONSIVE_TARGET = {
  label: 'TARGET',
  lines: ['ENTRY 001', 'ENTRY COVER', 'HOMEPAGE HERO'],
} as const;

export const TWIN_SPARK_RESPONSIVE_STAGE = {
  stageLabel: 'STAGE',
...
export const TWIN_SPARK_RESPONSIVE_HERO = {
...
export type TwinSparkResponsiveRailAction = {
  readonly id: string;
...
export const TWIN_SPARK_RESPONSIVE_RAIL_ACTIONS: readonly TwinSparkResponsiveRailAction[] = [
...
export type TwinSparkResponsiveCandidateSurface = 'plate' | 'grain' | 'collage' | 'archive';
...
export type TwinSparkResponsiveOutputColumn = {
  readonly id: string;
  readonly label: string;
...
export const TWIN_SPARK_RESPONSIVE_OUTPUT_COLUMNS: readonly TwinSparkResponsiveOutputColumn[] = [
  {
    id: 'grounding',
    label: 'GROUNDING',
...
export const TWIN_SPARK_RESPONSIVE_CHECKS = [
...
export const TWIN_SPARK_RESPONSIVE_STATUS_ROWS = [
...
export const TWIN_SPARK_RESPONSIVE_NEXT_ACTION = {
  label: 'NEXT ACTION',
...
export const TWIN_SPARK_RESPONSIVE_READINESS = {
  label: 'READINESS',
  percent: 82,
  state: 'READY',
  compiler: 'COMPILER:',
...
export const TWIN_SPARK_RESPONSIVE_CONCEPT_TABS = [
  'CONCEPT DATA',
  'VERSION HISTORY',
  'CHANGE HISTORY',
  'MASTER UPDATE',
...
export const TWIN_SPARK_RESPONSIVE_CONCEPT_FIELDS = [
...
export const TWIN_SPARK_RESPONSIVE_AMENDMENT = {
...
export const TWIN_SPARK_RESPONSIVE_BOTTOM_NAV = [
...
export const TWIN_SPARK_RESPONSIVE_AUTHORITY_PAIR = {
...
export const TWIN_SPARK_RESPONSIVE_SELECT_ACTIONS = {
  mobile: { label: 'SELECT FOR MOBILE', state: 'SELECTED' },
  desktop: { label: 'SELECT FOR DESKTOP' },
} as const;

export const TWIN_SPARK_RESPONSIVE_HEADER = {
  brand: 'SITE 00',
...
export const TWIN_SPARK_RESPONSIVE_CONTEXT = {
  chip: 'NDXBOOK',
  stream: 'CULTURAL_INTELLIGENCE_EDITORIAL',
  right: 'PROJECT CREATIVE CONTEXT',
} as const;

export const TWIN_SPARK_RESPONSIVE_GALLERY = {
  title: 'CONCEPT CANDIDATE GALLERY',
  compare: 'COMPARE CONCEPTS',
} as const;

export const TWIN_SPARK_RESPONSIVE_OUTPUT_TITLE = 'STRUCTURED OUTPUT REVIEW';
export const TWIN_SPARK_RESPONSIVE_PIPELINE_TITLE = 'PIPELINE / READINESS';
 ...
 */
export const TWIN_SPARK_RESPONSIVE_PAPER_TEXTURE =
