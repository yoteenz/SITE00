/**
 * P0.VR.DESIGNBENCH.SPARK-RESPONSIVE-OPUSGROK1 — inline SVG icon set for the isolated Opus
...
export function TsrIconMenu({ className }: IconProps) {
  return (
...
export function TsrIconCaretDown({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconChevronUp({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconChevronRight({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconEllipsisVertical({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <g fill="currentColor">
...
export function TsrIconPhone({ className }: IconProps) {
  return (
...
export function TsrIconTablet({ className }: IconProps) {
  return (
...
export function TsrIconDesktop({ className }: IconProps) {
  return (
...
export function TsrIconLock({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconLockOpen({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconCheck({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconCheckCircle({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconWarnCircle({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <circle cx="12" cy="12" r="10" fill="currentColor" />
...
export function TsrIconDot({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconSliders({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconCycle({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconInspect({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <g {...STROKE} strokeWidth={1.8}>
...
export function TsrIconExpand({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <g {...STROKE} strokeWidth={2}>
...
export function TsrIconCompare({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <g {...STROKE} strokeWidth={1.8}>
...
export function TsrIconDoc({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
export function TsrIconDocGear({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <g {...STROKE} strokeWidth={1.7}>
        <path d="M6 2.8h8.2L19 7.6V21.2H6z" />
...
export function TsrIconGrid({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <g fill="currentColor">
...
export function TsrIconHistory({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <g {...STROKE} strokeWidth={1.7}>
...
export function TsrIconDocArrow({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <g {...STROKE} strokeWidth={1.7}>
...
export function TsrIconShieldCheck({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <g {...STROKE} strokeWidth={1.7}>
...
export function TsrIconBolt({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
