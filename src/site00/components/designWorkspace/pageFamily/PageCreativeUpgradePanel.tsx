      ...
      <div className="site00-pfw-upgrade">
        <div className="site00-pfw-upgrade__compare">
          <figure>
            ...
            {currentScreenshot ? <img src={currentScreenshot} alt="Current page" /> : <div className="site00-pfw-upgrade__empty">NO CAPTURE</div>}
          </figure>
        ...
        {plan && !showAfter ? (
          <div className="site00-pfw-upgrade__plan">
            <p><strong>PURPOSE</strong> {plan.pagePurpose}</p>
            <p><strong>GOAL</strong> {plan.experienceGoal}</p>
            <p><strong>PRESERVE</strong> {plan.preserveFunction.join(', ')}</p>
          </div>
        ) : null}
