...
export const ASSTS_LOADER_COMPOSITION = {
  ...
  siteLabel: { x: 315, y: 900, w: 81, h: 32, centerX: 355.5 },
  headline: { x: 48, y: 940, w: 616, h: 104, centerX: 355.5 },
  subtitle: { x: 120, y: 1052, w: 472, h: 40, centerX: 355.5 },
  status: { x: 285, y: 1108, w: 141, h: 26, centerX: 355.5 },
  progressTrack: { x: 97, y: 1166, w: 482, h: 8 },
  progressPercentage: { x: 599, y: 1157, w: 40, h: 25 },
  brandStatement: { x: 165, y: 1241, w: 380, h: 34, centerX: 355.5 },
  siteMark: { x: 312, y: 1336, w: 88, h: 102, centerX: 355.5 },
} as const;
...
export const ASSTS_LOADER_Y_LANDMARKS: { label: string; y: number }[] = [
  ...
  { label: 'SITE 00 EYEBROW', y: 900 },
  { label: 'HEADLINE', y: 940 },
  { label: 'SUBTITLE', y: 1052 },
  { label: 'STATUS', y: 1108 },
  { label: 'PROGRESS TRACK', y: 1166 },
  { label: 'BRAND STATEMENT', y: 1241 },
  { label: 'SITE MARK', y: 1336 },
  { label: 'LOWER BREATHING', y: 1440 },
];
