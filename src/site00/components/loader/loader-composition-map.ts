...
export const ASSTS_LOADER_COMPOSITION = {
  ...
  siteLabel: { x: 315, y: 72, w: 81, h: 24, centerX: 355.5 },
  headline: { x: 85, y: 113, w: 542, h: 43, centerX: 355.5 },
  subtitle: { x: 184, y: 175, w: 344, h: 27, centerX: 355.5 },
