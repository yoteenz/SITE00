...
export const ASSTS_LOADER_COMPOSITION = {
  ...
  siteLabel: { x: 315, y: 820, w: 81, h: 32, centerX: 355.5 },
  headline: { x: 48, y: 856, w: 616, h: 104, centerX: 355.5 },
  subtitle: { x: 120, y: 968, w: 472, h: 40, centerX: 355.5 },
...
export const ASSTS_LOADER_Y_LANDMARKS: { label: string; y: number }[] = [
  ...
  { label: 'SITE 00 EYEBROW', y: 820 },
  { label: 'HEADLINE', y: 856 },
  { label: 'SUBTITLE', y: 968 },
  { label: 'STATUS', y: 1037 },
