...
export const ASSTS_LOADER_COMPOSITION = {
  ...
  siteLabel: { x: 315, y: 830, w: 81, h: 32, centerX: 355.5 },
  headline: { x: 48, y: 870, w: 616, h: 104, centerX: 355.5 },
  subtitle: { x: 120, y: 982, w: 472, h: 40, centerX: 355.5 },
...
export const ASSTS_LOADER_Y_LANDMARKS: { label: string; y: number }[] = [
  ...
  { label: 'SITE 00 EYEBROW', y: 830 },
  { label: 'HEADLINE', y: 870 },
