...
export const ASSTS_LOADER_COMPOSITION = {
  ...
  siteLabel: { x: 315, y: 72, w: 81, h: 28, centerX: 355.5 },
  headline: { x: 48, y: 108, w: 616, h: 96, centerX: 355.5 },
  subtitle: { x: 120, y: 212, w: 472, h: 32, centerX: 355.5 },
...
export const ASSTS_LOADER_Y_LANDMARKS: { label: string; y: number }[] = [
  ...
  { label: 'HEADLINE', y: 108 },
  { label: 'SUBTITLE', y: 212 },
  { label: 'STATUS', y: 1037 },
