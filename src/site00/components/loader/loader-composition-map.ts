...
export const ASSTS_LOADER_COMPOSITION = {
  ...
  siteLabel: { x: 315, y: 72, w: 81, h: 32, centerX: 355.5 },
  headline: { x: 48, y: 113, w: 616, h: 104, centerX: 355.5 },
  subtitle: { x: 120, y: 228, w: 472, h: 40, centerX: 355.5 },
...
export const ASSTS_LOADER_Y_LANDMARKS: { label: string; y: number }[] = [
  ...
  { label: 'SITE 00 EYEBROW', y: 72 },
  { label: 'HEADLINE', y: 113 },
  { label: 'SUBTITLE', y: 228 },
  { label: 'STATUS', y: 1037 },
