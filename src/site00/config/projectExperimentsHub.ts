  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: 'motion-character-book-language',
          title: 'MOTION + BOOK LANGUAGE',
          path: site00ProjectMotionCharacterPath(projectSlug),
          description: 'P0.5E.2 — book cultural language, content ontology, motion character foundation.',
        },
        {
          id: 'embodied-character-discovery',
          title: 'EMBODIED CHARACTER DISCOVERY',
          path: site00ProjectEmbodiedCharacterDiscoveryPath(projectSlug),
          description: 'P0.5E.3 — discover WHO the embodied NDX character is before visual casting.',
        },
        {
          id: 'founder-character-discovery',
          title: 'FOUNDER CHARACTER DISCOVERY ROOM',
          path: site00ProjectFounderCharacterDiscoveryPath(projectSlug),
          description: 'P0.5E.4 — meet, challenge, and confirm character truth before synthesis or casting.',
        },
        {
          id: 'character-continuity-pipeline',
          title: 'CHARACTER CONTINUITY PIPELINE',
          path: site00ProjectCharacterContinuityPath(projectSlug),
          description: 'P0.5E.5 — Bible ingestion, continuity authority, provider-aware FAL generation readiness.',
        },
      ],
    },
    {
