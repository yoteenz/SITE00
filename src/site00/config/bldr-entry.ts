...
/** Approved Enterprise environment — null until asset is published; portal uses asset slot fallback. */
export const SITE00_BLDR_ENTRY_ENTERPRISE_IMAGE: string | null = null;
