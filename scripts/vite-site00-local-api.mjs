...
function applyServerEnv() {
  ...
  const pairs = [
    ...
    ['FAL_KEY', env.FAL_KEY],
    ['SOL_DESIGN_BENCH_API_KEY', env.SOL_DESIGN_BENCH_API_KEY],
    ['SOL_DESIGN_BENCH_API_URL', env.SOL_DESIGN_BENCH_API_URL],
    ['SOL_DESIGN_BENCH_MODEL', env.SOL_DESIGN_BENCH_MODEL],
