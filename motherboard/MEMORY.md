...
- **Fix:** Desktop-scoped CSS — trailing row dividers removed; section headings +4px below; welcome block `transform: translate(-240px, -120px)` with top paint buffer; **overflow: visible** on Enter shell/ui-layer/main (was clipping transformed welcome copy); body copy `white-space: nowrap`; menu panel `transform: translate(202px, -48px)`.
