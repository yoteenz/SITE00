...
- **Fix:** Desktop-scoped CSS — trailing row dividers removed; section headings +4px below; welcome block `transform: translate(-240px, -120px)`; body copy `white-space: nowrap`; menu panel `transform: translate(202px, -48px)`.
