...
| `/projects/:slug/design/twin-sol-direct` | Isolated Sol **structural** reconstruction of the same golden (SOL-DIRECT1 / R1). **GROK-ASSET1** replaces placeholder plates only — Sol shell/section geometry stays frozen. Real DOM/CSS; no raster cheat; no CTRL ROOM guard. |
